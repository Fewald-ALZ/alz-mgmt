...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "fernandoewald@alvesewald.com"
    ...
    # IP Ranges Primary
    # Regional Address Space: 172.16.0.0/22
    ...
    # IP Ranges Secondary
    # Regional Address Space: 172.16.4.0/22
    secondary_hub_address_space                          = "172.16.4.0/22"
    secondary_hub_virtual_network_address_space          = "172.16.4.0/22"
    secondary_firewall_subnet_address_prefix             = "172.16.4.0/26"
    secondary_firewall_management_subnet_address_prefix  = "172.16.4.192/26"
    secondary_bastion_subnet_address_prefix              = "172.16.4.64/26"
    secondary_gateway_subnet_address_prefix              = "172.16.4.128/27"
    secondary_private_dns_resolver_subnet_address_prefix = "172.16.4.160/28"
  }
